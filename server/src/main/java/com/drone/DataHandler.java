...
//    // @Produces(MediaType.TEXT_PLAIN)
//    public void onMessageReceive(String messageJson) {
...
//    }
    ...
    public ServerData getClientData(String json) {
        ...
        try {
            //Send to other drones if available
//            String threadLabel = "Thread send time: " + System.currentTimeMillis();
//            Thread thread = Utils.create(threadLabel, () -> {
////                ServerUtils.processClientData(messageJson, ipAddress);
...
//            return processClientData(json);
            return ServerUtils.processClientData(json, ipAddress);
        } catch (Exception exception) {
            exception.printStackTrace();
